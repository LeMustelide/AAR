...
//        Si on veut supprimer les messages de l'utilisateur sans l'attribut cascade
//        List<Message> messages=em.createQuery("select m from Message m where m.from.login=:n or m.to.login=:n").setParameter("n",login).getResultList();
